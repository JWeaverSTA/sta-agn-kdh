...
corrmag_i_mask = dat['i_dered_'+dlaw+'_amag'] == dat['i_dered_'+dlaw+'_amag']
...
corrmag_g = dat['g_dered_'+dlaw+'_amag']
corrmag_i = dat['i_dered_'+dlaw+'_amag']
...
ax12tx.axis('off')
ax12tx.hist( meancol_gi, color = 'purple', alpha = 0.2,
...
ax12ty.axis('off')
ax12ty.hist( meanmag_g, color = 'purple', alpha = 0.2,
             bins = eybins, histtype='stepfilled',
...
ax22tx.axis('off')
ax22tx.hist( diskcol_gi, color = 'purple', alpha = 0.2,
             bins = exbins, histtype='stepfilled')
...
ax22ty.hist( diskmag_g, color = 'purple', alpha = 0.2,
             bins = eybins, histtype='stepfilled',
			 orientation = 'horizontal')
ax22ty.invert_xaxis()
...
ax32tx.axis('off')
ax32tx.hist( corrcol_gi, color = 'purple', alpha = 0.2,
             bins = exbins, histtype='stepfilled')
...
ax32ty.axis('off')
ax32ty.hist( corrmag_g, color = 'purple', alpha = 0.2,
             bins = eybins, histtype='stepfilled',
			 orientation = 'horizontal')
ax32ty.invert_xaxis()
